...
from .configs import CACHE_ENABLE


class _ReadFileSingleton(metaclass=SingletonMeta()):
...
read_html_head = _ReadFileSingleton().read_html_head
read_html_body = _ReadFileSingleton().read_html_body
read_html = _ReadFileSingleton().read_html
read_css = _ReadFileSingleton().read_css
read_js = _ReadFileSingleton().read_js
read_sql = _ReadFileSingleton().read_sql
