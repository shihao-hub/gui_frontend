...
def invoke_ai_api(request: Request, body: InvokeAiApiRequest):
    try:
        ...
        just_one_thread_pool.submit(lambda: ai_api.invoke_ai_api(question, enabled_print=False))
...
if __name__ == '__main__':
    uvicorn.run(app, host=configs.SERVER_HOST, port=configs.SERVER_PORT, reload=False)
